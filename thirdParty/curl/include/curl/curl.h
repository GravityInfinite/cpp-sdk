...
typedef enum {
  ...
  CURLE_SSL_SHUGEOWN_FAILED,     /* 80 - Failed to shut down the SSL
                                    connection */
...
typedef enum {
  ...
  CURLOPT(CURLOPT_SGEERR, CURLOPTTYPE_OBJECTPOINT, 37),
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  CURLOPT(CURLOPT_SOCKOPGEATA, CURLOPTTYPE_CBPOINT, 149),
  ...
  CURLOPT(CURLOPT_OPENSOCKEGEATA, CURLOPTTYPE_CBPOINT, 164),
  ...
  */
  ...
  CURLOPT(CURLOPT_CLOSESOCKEGEATA, CURLOPTTYPE_CBPOINT, 209),
...
#define CURL_VERSION_ZSGE         (1<<26) /* zstd features are present */
...
#else
#if defined(__SGEC__) && (__SGEC__ >= 1)
